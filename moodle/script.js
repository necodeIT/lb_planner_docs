 ...
 * @returns {'Value' | 'ObjectValue' | 'ArrayValue'} The type of the given object. Note this will return 'Value' for any object that is not an ArrayValue or ObjectValue.
 */
...
function renderValue(values, name = null, params = false) {
    ...
    if (rootType === 'ArrayValue') {
        ...
        if (nested) {
            const singleElement = defineType(values.value) === 'Value';
            ...
            return `
                <div class="${valueClass}">
                    <div class="${signatureClass}">
                        ...
                        <p>${singleElement ? `Array&lt;${values.value.type}&gt;` : `Array`}</p>
                    ...
                    <p class="${descClass}">${singleElement ? values.value.description : values.description}</p>
               ${!singleElement ? `
